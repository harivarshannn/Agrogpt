...
def analyze_image_for_disease(image_path: str) -> str:
    ...
    try:
        ...
        prompt = (
            ...
            f"Provide detailed advice for the farmer including:\n"
            f"1. Confirmation of symptoms typically associated with this condition.\n"
            f"2. Recommended treatments (organic and chemical).\n"
            f"3. Preventive measures.\n"
            f"4. A brief summary in Malayalam (മലയാളം) AND Tamil (தமிழ்) if possible.\n\n"
